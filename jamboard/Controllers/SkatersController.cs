...
namespace jamboard.Controllers
{
    public class SkatersController : Controller
    {
        ...
        {
            ViewData["Teams"] = db.Teams; // (IEnumerable<SelectListItem>)new SelectList(db.Teams, "Id", "Name");
        }
        // GET: Skaters/Create
        ...
        public ActionResult Create([Bind(Include = "Name,Number,TeamId")] Skater skater)
        {
